...
export default function SystemHeade(props) {
    const { username } = props
    const [time, setTime] = useState("1997-01-01 00:00:00")
    useEffect(() => {
